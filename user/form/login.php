...
<head>
    ...
    <style>
        ...
        .btn-register {
            background-color: #ffc107; /* Yellow background for register button */
            color: #ffffff;
        }
        .btn-login {
            background-color: #dc3545; /* Red background for login button */
            color: #ffffff;
        }
    </style>
</head>
...
<div class="container">
    <div class="row">
        <div class="col-md-6 mt-5 m-auto login-form">
            ...
            <form action="login1.php" method="POST">
                ...
                <div class="mb-3">
                    <button class="w-100 btn-login fs-4">LOGIN</button>
                </div>
                <div class="mb-3">
                    <button name="submit" class="w-100 btn-register fs-4">
