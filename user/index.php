...
$query = "SELECT * FROM tblproduct WHERE PCategory = 'Home'";
if ($search) {
...
<div class="col-md-2 bg-dark text-center text-white mt-5 m-auto">
        <a href="index1.php" class="text-white text-decoration-none fs-4 fw-bold px-5">LIVE CHAT</a>
</div>
